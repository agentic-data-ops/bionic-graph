    ...
    <aside className={`${collapsed ? 'w-12' : 'w-64'} flex flex-col h-full bg-[var(--bg-secondary)] border-r border-[var(--border)] overflow-hidden transition-all duration-200 flex-shrink-0`}>
      ...
      {!collapsed && (
        <>
          ...
          <div className="border-t border-[var(--border)]">
            ...
            <div className="px-3 py-1.5">
              <button className="w-full py-2 px-3.5 rounded-xl text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)] hover:text-[var(--text-primary)] text-sm font-medium flex items-center gap-2.5 transition-all duration-200" onClick={onOpenGraphManager}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
      ...
      {collapsed && (
        <div className="mt-auto border-t border-[var(--border)] px-2 py-2 flex flex-col gap-1">
          ...
          <button className="w-8 h-8 rounded-lg bg-[var(--bg-tertiary)] hover:bg-[var(--bg-hover)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all mx-auto" onClick={onOpenGraphManager} title={t('settings.graphs')}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
            </svg>
          </button>
